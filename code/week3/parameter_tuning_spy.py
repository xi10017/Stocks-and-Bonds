"""
VIX Strategy Parameter Tuning - Week 3 (SPY 2002-2025)
...
def calculate_strategy_metrics(df, lookback_window, percentile_cutoff, 
    ...
    """
    Calculate strategy metrics with progressive allocation.
    ...
    metrics = calculate_metrics(df["Strategy_Return"], risk_free_rate)
    ...
    if metrics and metrics["sharpe"] > 2.5:
        ...
        manual_sharpe = (excess_returns.mean() / df["Strategy_Return"].std()) * np.sqrt(252)
...
fig.suptitle(f"VIX Strategy Parameter Tuning (SPY 2002-2025)\nBest Scaling: {scaling_label}", 
             fontsize=14, fontweight='bold', y=1.02)
plt.tight_layout()
plt.savefig("../../results/week3/parameter_tuning.png", dpi=150, bbox_inches="tight")
print(f"\n✓ Saved: results/week3/parameter_tuning.png")
...
param_df.to_csv("../../data/week3/parameter_tuning_progressive.csv", index=False)
print(f"✓ Saved: data/week3/parameter_tuning_progressive.csv")
...
fig1.suptitle("VIX Strategy vs S&P 500 Baseline (SPY 2002-2025)\nAll Scaling Functions Comparison (Green = Better, Red = Worse)", 
              fontsize=16, fontweight='bold', y=0.995)
plt.tight_layout(rect=[0, 0, 1, 0.98])
fig1.savefig("../../results/week3/parameter_tuning_vs_sp500.png", dpi=150, bbox_inches="tight")
print(f"✓ Saved: results/week3/parameter_tuning_vs_sp500.png")
...
fig2.suptitle("VIX Strategy vs 10Y Treasury Baseline (SPY 2002-2025)\nAll Scaling Functions Comparison (Green = Better, Red = Worse)", 
              fontsize=16, fontweight='bold', y=0.995)
plt.tight_layout(rect=[0, 0, 1, 0.98])
fig2.savefig("../../results/week3/parameter_tuning_vs_bonds.png", dpi=150, bbox_inches="tight")
print(f"✓ Saved: results/week3/parameter_tuning_vs_bonds.png")
